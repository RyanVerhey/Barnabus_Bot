...
namespace :db do
  ...
  db_config       = YAML::load(File.open('config/database.yaml'))[ENVIRONMENT]
  db_config_admin = db_config.merge({'database' => 'mysql', 'schema_search_path' => 'public', 'username' => 'root', 'password' => ENV["ROOT_DB_PASS"]})
